...
-- This mod's own root.  In the Gen1Wild bundle the same file reads
-- `modules/Gen1MenuManager`; here the mod IS the repository.
local DIR = os.getenv("GEN1MENUMANAGER_DIR") or "."
